            ...
            <Box sx={{ paddingLeft: "10px", paddingTop: "10px", width: "40%", marginBottom: "30px" }}>
              ...
              <Add sx={{ color: "white" }}></Add>
                    ...
                    <Grid item xs={12}>
                        ...
                        <TextField id="project-name" placeholder="Kiểu dáng" variant="outlined" sx={{ width: "100%" }} />
                    </Grid>
                    <Grid item xs={12}>
                        <Typography variant="body2" color="#DD8501">Đơn giá trọn gói</Typography>
                        <TextField id="project-name" placeholder="Đơn giá" variant="outlined" sx={{ width: "100%" }} />
                    </Grid>
                    <Grid item xs={12}>
                        <Box sx={{
                            width: "100%",
