...
const DialogReportProject = (props) => {
  ...
  const valideSchema = yup
    .object({
      itemAmount: yup.number().typeError('amount is invalide').min(1, 'Số lượng phải lớn hơn 0!').required(),
      itemDesc: yup.string().required(),
      itemPrice: yup.number().typeError('Price is invalide').min(1, 'Giá tiền phải lớn hơn 0!').required(),
