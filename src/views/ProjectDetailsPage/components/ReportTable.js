...
function createData(name, progress, perform, start, end, durationn, status, prioritized) {
  return {
    name,
    progress,
    perform,
...
const rows = [
  createData('Buildlink trên PBN 05/09', "100%", 'Nguyễn Văn A', '05/09/2022', '06/09/2022', 1, 'Hoàn thành', ''),
];
